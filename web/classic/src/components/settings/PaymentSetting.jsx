...
import SettingsPaymentGatewayUSAD from '../../pages/Setting/Payment/SettingsPaymentGatewayUSAD';
        ...
        <Card style={{ marginTop: '10px' }}>
          ...
          >
            ...
            >
              ...
              <Tabs.TabPane tab={t('USAD 设置')} itemKey='usad'>
                <SettingsPaymentGatewayUSAD
                  options={inputs}
                  refresh={onRefresh}
                  hideSectionTitle
                />
